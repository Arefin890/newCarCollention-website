...
const MyOrders = () => {
    ...
    useEffect(() => {
        fetch('https://hidden-plains-93695.herokuapp.com/purchase/byEmail', {
            method: "POST",
            headers: {
    ...
    useEffect(() => {
        fetch('https://hidden-plains-93695.herokuapp.com/purchases')
            .then(res => res.json())
    ...
    const handleDeleteOrder = id => {
        const url = `https://hidden-plains-93695.herokuapp.com/purchases/${id}`;
        fetch(url, {
            method: 'DELETE'
        })
            .then(res => res.json())
